...
export function StreakCard() {
  ...
  return (
    <div
      className="p-4 sm:p-5 rounded-2xl flex flex-col justify-between h-full"
      style={{
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-amber-500/12 border border-amber-500/25 flex items-center justify-center flex-shrink-0">
      ...
      <div className="grid grid-cols-7 gap-1 sm:gap-2 text-center">
        {days.map((item) => (
          <div key={item.day} className="flex flex-col items-center gap-1.5 sm:gap-2">
            <div
              className={`w-7.5 h-7.5 sm:w-9 sm:h-9 rounded-full flex items-center justify-center text-xs transition-all duration-300 ${
                item.completed
            ...
            >
              {item.completed ? (
                ...
                <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-amber-400 animate-pulse" />
              ) : (
